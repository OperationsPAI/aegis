...
func NewAuthLoginReq(password string, username string) *AuthLoginReq {
	this := AuthLoginReq{}
...
func (o *AuthLoginReq) GetPassword() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *AuthLoginReq) GetPasswordOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AuthLoginReq) SetPassword(v string) {
	o.Password = v
}

// GetUsername returns the Username field value
func (o *AuthLoginReq) GetUsername() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AuthLoginReq) GetUsernameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AuthLoginReq) SetUsername(v string) {
	o.Username = v
}
...
func (o *AuthLoginReq) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAuthLoginReq)
