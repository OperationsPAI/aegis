...
type ShareLink struct {
	...
	// LifecycleState distinguishes pending presigned-PUT reservations
	// ('pending') from finalised share rows ('live'). Default 'live' keeps
	// pre-migration rows valid; pending rows become live via CommitUpload.
	LifecycleState string         `gorm:"size:16;not null;default:live;index" json:"lifecycle_state"`
